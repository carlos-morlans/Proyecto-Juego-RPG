...
class Combate {
	// este metodo empezo siendo void y paso a ser boolean para saber cuando acaba
	// el juego
	...
	// ultima comprobacion de que sigues vive y pasas a otra ronda, y al devolver
	// true demuestras que sigues vivo
	 ...
	 * System.out.println("1.Si "); System.out.println("2.No, puedo con el ");
	 * 
	 * int huida = scanner.nextInt();
	 * 
	 * if(huida==1) {
	 * 
	 * } else { System.out.println("MUY BUENA ELECCIÓN, A POR EL!");
	 * System.out.println("--------------------------------------");
	 * pelear(jugador,enemigo); }
	 * 
	 * 
	 * public void huidasRestantes(Personaje jugador) {
	 * 
	 * }
	 * 
	 * 
	 * 
	 * public void setHuidasRestantes(int huidasRestantes) { this.huidas =
	 * huidasRestantes; }
	 */
